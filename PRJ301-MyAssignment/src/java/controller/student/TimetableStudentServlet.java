 ...
 * @author tuant
 */
@WebServlet(name="TimetableStudentServlet", urlPatterns={"/timetableStudent"})
public class TimetableStudentServlet extends BaseRequiredAuthenticatedControllerForStudent {
